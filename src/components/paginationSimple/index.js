...
class PaginationSimple extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      page: this.props.page || 0, // 当前页码
      pageSize: this.props.pageSize || 20, // 当前分页数量
      total: this.props.total || 0, // 总数量
      pageCount: this.props.pageCount || 0, // 总的页数
  ...
  prePageClick() {
    ...
    this.setState({
      ...
      try {
        this.props.pageAndSizeChange(this.state.page, pageSize);
      } catch (err) {
        // dsd
      }
    });
