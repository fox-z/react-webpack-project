...
class MarketGoodsRecommend extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      shopId: '', // 搜素 店铺ID
      shopName: '', // 搜素 店铺名称
      goodsTitle: (this.props.location.query && this.props.location.query.goodsTitle) || '', // 搜素 商品标题
      goodsList: [
        // {
        //   key: 0,
        //   shopId: 23444,
  ...
  reqData(p) {
    const {
      page, pageSize, shopId, shopName, goodsTitle,
...
export default MarketGoodsRecommend;
